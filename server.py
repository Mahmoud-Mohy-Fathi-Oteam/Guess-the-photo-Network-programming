...
top = Tk()
top.title("Guess the photo (server)")
top.geometry("630x500")
top.config(bg="Darkred")
...
def clickDog():
    ...
    flag = True
    myRespond = "dog"
    myChoiceLabel.config(image=dogImg, width=220, height=250, bg="white", highlightbackground="black",
...
canvas = Canvas(top, width=520, height=5, bg="#8B0000", highlightbackground="#8B0000")
canvas.place(x=50, y=355)
canvas.create_line(0, 5, 520, 5)

frame = Frame(top, width=520, height=100, bg="#8B0000")
frame.place(x=50, y=370)

dogButton = Button(frame, image=dogImg, width=100, height=100, bg="white", bd=3, command=clickDog)
dogButton.place(x=0, y=0)

catButton = Button(frame, image=catImg, width=100, height=100, bd=3, bg="white", command=clickCat)
catButton.place(x=200, y=0)

sheepButton = Button(frame, image=sheepImg, width=100, height=100, bd=3, bg="white", command=clickSheep)
